...
# # Ajuda contextual para a seção 1
# with st.expander("💡 Ajuda - Extração de Relatório", expanded=False):
#     st.markdown("""
#     **O que faz esta etapa:**
#     - Analisa o PDF do processo judicial
#     - Extrai informações das principais seções (inicial, contestação, réplica, etc.)
#     - Organiza o conteúdo em um relatório estruturado
        
#     **Requisitos do arquivo:**
#     - Formato: PDF
#     - Tamanho máximo: 200MB
#     - Texto deve ser pesquisável (não apenas imagem)
        
#     **Tempo estimado:** 1-5 minutos dependendo do tamanho do processo (arquivos grandes podem demorar mais)
#     """)
...
# Ajuda contextual para a seção 2
# with st.expander("💡 Ajuda - Geração de Sentença", expanded=False):
#     st.markdown("""
#     **O que faz esta etapa:**
#     - Analisa o relatório extraído
#     - Busca referências na base de dados
#     - Gera uma sentença fundamentada
        
#     **Instruções Adicionais:**
#     - Use para orientar aspectos específicos da sentença
#     - Exemplo: "enfatizar danos morais", "valor específico de indenização"
        
#     **Documentos de Referência:**
#     - Adicione sentenças similares em formato DOCX
#     - Melhora a fundamentação jurídica
...
<div style="text-align: center; color: #666; font-size: 0.9em; margin-top: 2rem;">
    <p><strong>⚖️ Justino - Assessor Digital da 13ª Vara Cível</strong></p>
    <p>Versão BETA v2.1 | Desenvolvido para otimizar o trabalho judiciário</p>
    <p><em>⚠️ Sempre revise o conteúdo gerado antes do uso oficial</em></p>
</div>
